...
export function PebbleVsQuartzPost() {
  ...
  return (
    <div className="min-h-screen bg-white font-['DM_Sans',sans-serif] text-slate-700">
      ...
      <footer className="bg-[#0A0A0A] py-8 text-center text-sm text-white/70"><p>Rivera Pools Riverside · Pool plastering, remodeling, resurfacing, and repairs across Riverside County.</p><p className="mt-2">CA C-35 Contractor License #1053279 · Licensed, Bonded, &amp; Insured</p><a href="tel:+19513459276" className="mt-2 inline-block font-semibold text-white hover:text-[#67e8f9]">(951) 345-9276</a></footer>
    </div>
  );
}